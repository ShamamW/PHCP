...
donors <- F # list of donor populations
...
prefix_ancient_data <- options.args$ancient[1] # prefix of pseudo-haplotypes data
prefix_ancient_list <- options.args$ancient[length(options.args$ancient)] #prefix of pseudo-haplotypes list
prefix_modern_data <- options.args$modern[1] # prefix of phased data
prefix_modern_list <- options.args$modern[length(options.args$modern)] # prefix of phased samples list
...
## genetic distance between each pair of following SNPs
